<?php
 ...
 header("Content-type: text/css"); 
  ...
  /**
     ...
     * 
     * For example:
     *       echo hex2rgb('#0e2b3d' , '0.9'  , '!important' )  //input
...
.horizontal-middle-flex
{
    display:flex;
    justify-content:center;    
}

.horizontal-right-flex
{
    display:flex;
...
.justifycontent-left-tablet-center
{
...
@media(min-width:1200px)
{
    .drop-shadow-left, .drop-shadow-left:focus
    {
...
.collapsible-div-button.opened .flt
{
    transform:rotate(90deg);
}

.collapsible-div-button .dashboard-title3-bold
{
...
.form-control, .form-control:focus, .bootstrap-tagsinput
{
...
/* Selekt the form and remove the original arrow */
select.input-lg {
...
.select-custom-arrow, select + i.flt {
  float: right;
  margin-top: -45px;
  margin-right: 5px;
...
.primary-color2-checkbox.custom-checkbox .custom-control-input:checked~.custom-control-label::before
{
...
.file-upload, .file-upload-dashed
{
    opacity: 0;
    z-index: 2;
    position: relative;
...
.backend-module-edit-iconsholder 
{
    display:flex;
    justify-content:flex-end;
    align-items:center;
...
.backend-module-edit-iconsholder-left
{
...
.flaticon-writing, .flaticon-document, .flaticon-upload
{
    font-weight: 600;
}
.backend-module-edit-iconsholder .flt, .display-picture-iconsholder .flt, .display-picture-iconsholder .flt
{
    cursor:pointer;
...
.backend-module-edit-iconsholder .flaticon-document
{
    cursor:default;
}
...
@media(min-width:1200px)
{
    .backend-module-edit-iconsholder-left .flt
    {
        font-size:20px;
    }
    .module-card-div .card-holder
    {
        height:80px;
    }
...
.backend-course-image
{
    
}

.backend-course-image img
{
    width: 100%;
    height: 200px;
    object-fit: cover;
...
.display-picture-iconsholder label
{
    margin-bottom:0px;
}
.primary-color1-dashed-border
{
    border:5px dashed rgba(0,0,0,0.1)!important;
    border-bottom:0px!important;
}

.backend-module-thumbnail
{
    width: 90px;
    height: 90px;
    border-radius: 100px;
...
@media(min-width:1200px)   
{
    .backend-module-thumbnail-holder
    {
        max-width:100px;
    }
}
...
.courses-holder:hover h1, .courses-holder:hover h6
{
    color:#fff!important;   
}
...
.courses-holder .edit-icons
{

}

.courses-holder .edit-icons .flt
{
...
@media(min-width:992px)   
{
    ...
    .courses-holder:hover .edit-icons
    {
        display:block;
        
    }
    
    .courses-holder:hover .copies, .courses-holder:hover .revenue
    {
        display:none;
...
/*Big animatable button */

.big-animatable-button-arrow {
    border-style: dashed;
    border-color: transparent;
    border-width: 0.20em;
    display: -moz-inline-box;
...
.big-animatable-button:hover .big-animatable-button-inner
{
	width:100%;

}

.big-animatable-button:hover .big-animatable-button-arrow
{
	opacity:0;
	-webkit-transition: opacity 0.2s ease-out;
	-moz-transition: opacity 0.2s ease-out;
...
.big-animatable-button-arrow:before
{
	font-family: Flaticon!important;
    content: '\f117';
    display: block;
...
.watch-video iframe, .watch-video object, .watch-video embed 
{
  position: absolute;
  top: 0;
  left: 0;
...
@media(min-width:1200px)
{
    .mobile-overlapping-sidebar
    {
        height:100vh;
    }
    .bottom-buttons
    {
        margin:calc(100vh - 700px) auto 0px;
    }
}

@media(min-width:1200px)
{
    .col-xl-4-right-sidebar
    {
    position:fixed;right: 0;padding-right: 0px;padding-left: 70px;
    }
...
.top-bar-button:hover, .top-bar-button.current-page-button
{
    opacity:1;
}

/* Course/Product card hover module */
